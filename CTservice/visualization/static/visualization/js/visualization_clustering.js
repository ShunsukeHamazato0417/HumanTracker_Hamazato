...
class HumanObject{
  ...
  constructor(cen_x, cen_y, size, data, i, hue, DDflg){
    this.cen_x    = cen_x;
    this.cen_y    = cen_y;
    this.size     = size;
    this.data     = data;
  ...
  draw(p){
    ...
    p.ellipse((this.cen_x*this.data_reduce_rate-display_x)*expantion_rate/max_expantion_rate,
              (this.cen_y*this.data_reduce_rate-display_x)*expantion_rate/max_expantion_rate,
              this.size*this.data_reduce_rate/2, this.size*this.data_reduce_rate/2);
    p.text(p.str(this.id), (this.cen_x*this.data_reduce_rate-display_x)*expantion_rate/max_expantion_rate,
                           (this.cen_y*this.data_reduce_rate-display_x)*expantion_rate/max_expantion_rate);
